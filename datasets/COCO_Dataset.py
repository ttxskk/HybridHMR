...
class COCODataset(JointsDataset):
    ...
    def __init__(self, options, dataset, subset, use_augmentation=True, is_train=True):
        super(COCODataset, self).__init__(options, dataset, subset, use_augmentation, is_train)
    ...
    def _get_ann_file_keypoint(self):
        ...
        # return '/home/sunqingping/PycharmProjects/data/COCO/annotations/person_keypoints_val2017.json'
...
#     COCODataset(None,'coco','val2014',is_train=False)
